    ...
    *,
    ...
    with PseudoBridgeServer(
        ...
        initial_msg = (
            ...
            f"- After each Bash run completes without exception, proceed directly to the next step "
            f"(next sheet's script or results.json). Skip intermediate Read/Glob/ls tool calls — "
            f"they add overhead without improving correctness. The fail-file gate has no files in headless mode.\n"
